...
const newStudent2 = JSON.stringify(
  student,
...
let maxSkills = 0;
let maxSkillsStudent = "";
for (const studentName in newText) {
  if (newText[`${studentName}`].skills.length > maxSkills) {
    maxSkills = newText[`${studentName}`].skills.length;
    maxSkillsStudent = studentName;
  }
}
console.log(maxSkillsStudent);
